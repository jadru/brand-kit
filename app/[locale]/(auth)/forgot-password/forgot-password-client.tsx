    ...
    <div className="flex min-h-screen">
      ...
      <main id="main-content" className="flex flex-1 items-center justify-center px-6 py-12">
        <Card className="w-full max-w-md border-0 shadow-none lg:border lg:shadow-sm">
          ...
          <CardContent>
            {success ? (
              <div className="border-success/20 bg-success/5 space-y-4 rounded-md border p-4">
                <p className="text-success text-sm font-medium">{t('successTitle')}</p>
                <p className="text-text-secondary text-sm">{t('successDescription', { email })}</p>
                <Link
                  href="/login"
          ...
          <CardFooter className="justify-center">
            <Link href="/login" className="text-text-secondary text-sm hover:underline">
              {t('backToLogin')}
            </Link>
          </CardFooter>
        </Card>
